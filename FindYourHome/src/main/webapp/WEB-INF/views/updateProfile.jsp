...
<section>
<div>
<sform:form method="post" commandName="agent" action="updateProfile.htm">
	<table>
	<thead>
	<tr>
	<td>
	...
	<td><sform:input  path="firstName" size="30" maxlength="30" /></td>
	<td><sform:errors path="firstName" class="errors" /> </td>
	</tr>
	
	<tr>
	<td><label>Last Name</label></td>
	<td><sform:input  path="lastName" size="30" maxlength="30"/></td>
	...
	<td><sform:input  path="agencyName" size="30" /></td>
	<td><sform:errors path="agencyName" class="errors" /> </td>
	</tr>
	
	<tr>
	<td><label>Agency Type</label></td>
	<td><sform:input  path="agentType" size="30" /></td>
	<td><sform:errors path="agentType" class="errors" /> </td>
	</tr>
	...
	<tr>
	<td></td>
	<td><input type="submit" class="btn btn-primary" value="Update Profile" /></td>
	</tr>
</tbody>
